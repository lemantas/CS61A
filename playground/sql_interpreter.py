...
cities = [CitiesRow(30, 120, "Siauliai"),
          CitiesRow(50, 130, "Paneveys"),
          CitiesRow(20, 110, "Vilnius")]
...
def create_make_row(description):
	"""Return a function from an input environment to an output row.
...
def join(tables, env):
	"""Return an iterator over dictionaries from names to vlaues in a row.
	tables - a comma-separate sequences of tables names
...
print("\nStoring previous table in the environment and making additional join:\n")
